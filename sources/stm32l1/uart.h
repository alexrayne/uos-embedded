 ...
 */
#ifndef _STM32L1_UART_H_
#define _STM32L1_UART_H_
...
typedef struct _stm32l1_uart_t stm32l1_uart_t;

struct _stm32l1_uart_t {
    uartif_t            uartif;
...
int stm32l1_uart_init(stm32l1_uart_t* uart, unsigned port);

#endif /* _STM32L1_UART_H_ */
