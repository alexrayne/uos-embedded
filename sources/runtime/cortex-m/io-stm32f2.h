/*
 * Register definitions for STM32F2xx.
 *
...
// OSPEEDR bits
#define GPIO_LOW(n)         (0 << (2 * n))  // Low speed
#define GPIO_MEDIUM(n)      (1 << (2 * n))  // Medium speed
#define GPIO_HIGH(n)        (2 << (2 * n))  // Fast speed
#define GPIO_VERY_HIGH(n)   (3 << (2 * n))  // High speed
...
#define GPIO_AF_I2S2(n)     (0x4 << (4 * ((n) & 7)))
#define GPIO_AF_SPI3(n)     (0x6 << (4 * ((n) & 7)))
#define GPIO_AF_I2S3(n)     (0x4 << (4 * ((n) & 7)))
