 ...
 */
#ifndef _STM32F3_UART_H_
#define _STM32F3_UART_H_
...
typedef struct _stm32f3_uart_t stm32f3_uart_t;

struct _stm32f3_uart_t {
    uartif_t            uartif;
...
int stm32f3_uart_init(stm32f3_uart_t* uart, unsigned port);

#endif /* _STM32F3_UART_H_ */
